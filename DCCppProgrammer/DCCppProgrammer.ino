...
//CNC Create LCD objet address 0x3F 16 col x 2 row
LiquidCrystal_I2C lcd(0x27,20,4);  //

//CNC KeyPad matrix 4x5
...
byte rowPins[ROWS] = {30, 29, 28, 27, 26}; //connect to the row pinouts of the keypad
byte colPins[COLS] = {22, 23, 24, 25}; //connect to the column pinouts of the keypad

//CNC initialize an instance of class NewKeypad
...
void setup(){  
  ...
  KeyPadLcd::init(&mainRegs, &progRegs, &mainMonitor, &customKeypad, &lcd);   //CNC create structure to read and parse commands from matrix keyboard and lcd display
